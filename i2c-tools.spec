...
Version  : 4.2
Release  : 14
URL      : https://www.kernel.org/pub/software/utils/i2c-tools/i2c-tools-4.2.tar.xz
Source0  : https://www.kernel.org/pub/software/utils/i2c-tools/i2c-tools-4.2.tar.xz
...
%prep
%setup -q -n i2c-tools-4.2
cd %{_builddir}/i2c-tools-4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600969035
...
cp %{_builddir}/i2c-tools-4.2/COPYING %{buildroot}/usr/share/package-licenses/i2c-tools/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/i2c-tools-4.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/i2c-tools/01a6b4bf79aca9b556822601186afab86e8c4fbf
